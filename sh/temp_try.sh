...
# 在新终端窗口中运行第一个命令
xterm -hold -e "cd /root/catkin_ws/src/Challege_ROS/object_det/scripts && python3 ForwardObjects_det.py" &

# 等待1秒
sleep 1

# 在新终端窗口中运行第2个命令
xterm -hold -e "cd /root/catkin_ws/src/Challege_ROS/object_det/scripts && python3 DownObjects_det.py" &
